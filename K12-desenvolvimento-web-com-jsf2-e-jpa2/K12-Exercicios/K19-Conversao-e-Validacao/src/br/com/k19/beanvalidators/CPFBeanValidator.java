...
public class CPFBeanValidator implements ConstraintValidator<CPF, br.com.k19.modelo.CPF> {
	...
	private boolean validaCPF(int numeroDeIdentificacao, int primeiroDigitoVerificador, int segundoDigitoVerificador){
		...
		long segundoDigito = this.modulo11((long) numeroDeIdentificacao*10 + primeiroDigitoVerificador);
